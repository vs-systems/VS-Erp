<?php
/**
 * Catálogo Gremio - VS System
 * Estilo unificado con catalogo_publico.php
 */
session_start();
...
<head>
    ...
    <title>Catálogo Gremio - Vecino Seguro</title>
...
<body class="antialiased overflow-x-hidden">
    ...
    <nav class="glass-header sticky top-0 z-50 px-6 py-4 flex items-center justify-between">
        <div class="flex items-center gap-4">
            ...
            <div class="flex flex-col">
                ...
                <span class="text-xs text-[#136dec] font-medium tracking-tight uppercase">Catálogo Gremio</span>
            </div>
        </div>
        ...
        <div class="flex items-center gap-6">
            ...
            <a href="index.php"
                ...
                <span class="material-symbols-outlined text-sm">dashboard</span> PANEL ERP
            </a>
        </div>
    </nav>
    ...
    <section class="relative pt-20 pb-16 px-6 text-center">
        <div class="max-w-4xl mx-auto space-y-4">
            <h1 class="text-5xl md:text-6xl font-extrabold tracking-tighter text-white">Precios <span
                    class="gradient-text">Gremio</span></h1>
            <p class="text-slate-400 text-lg md:text-xl font-medium max-w-2xl mx-auto leading-relaxed">
                Acceso exclusivo para instaladores y revendedores. Stock en tiempo real y precios mayoristas + IVA.
            </p>
        </div>
    </section>
    ...
    <main class="max-w-7xl mx-auto px-6 pb-20">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8" id="productGrid">
            <?php foreach ($allProducts as $p):
                ...
                $priceGremioArs = $priceListModule->getPriceByListName($cost, $iva, 'Gremio', $exchangeRate, true);
                ...
                $pData = [
                    ...
                    'price_final_usd' => number_format($priceGremioArs / $exchangeRate, 2, '.', '')
                ];
                ?>
                <div class="product-card bg-[#16202e] rounded-2xl p-4 flex flex-col group cursor-pointer <?php echo ($stock <= 0) ? 'opacity-60 grayscale' : ''; ?>"
                    ...
                    <div class="flex-1 flex flex-col">
                        ...
                        <div class="mt-auto flex items-center justify-between gap-2 pt-4 border-t border-[#233348]">
                            <div>
                                <span class="block text-[10px] text-slate-500 font-bold uppercase">Gremio (+IVA)</span>
                                <span class="text-lg font-extrabold text-[#10b981]">ARS
                                    <?php echo number_format($priceGremioArs, 0, ',', '.'); ?></span>
                            </div>
    ...
    <div id="cartModal"
        ...
        <div
            ...
            <div class="flex items-center gap-3">
                ...
                <h3 class="text-lg font-bold">Tu Pedido Gremio</h3>
            </div>
