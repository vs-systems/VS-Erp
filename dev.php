        ...
        <div class="max-w-6xl w-full text-center z-10 space-y-12 py-20">
            ...
            <div
                ...
                $modules = [
                    ...
                    ['name' => 'Portal Web B2B/B2C', 'status' => 'Actual',       'icon' => 'storefront', 'url' => 'catalogo_web.php'],
            ...
            <div
                ...
                <a href="catalogo_web.php" target="_blank"
                    ...
                    <span class="material-symbols-outlined">storefront</span> PORTAL WEB B2B/B2C
                </a>
